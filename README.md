...
# Georg Christian Apel (1775–1841) – Vollständiges Choralbuch (A chorale corpus)

This corpus contains four-part chorale settings from Georg Christian Apel's _Vollständiges Choralbuch_ (1832), transcribed in the folder `1832_VollständigesChoralbuch`.

## Getting the data

* download the repository as a [ZIP file](https://github.com/Chorale-Corpus/Apel_GC/archive/refs/heads/main.zip)
* download a [Frictionless Datapackage](https://specs.frictionlessdata.io/data-package/) that includes concatenations of the TSV files in the folders `measures`, `notes`, and `chords`, and a JSON descriptor:
  * [apel_gc.zip](https://github.com/Chorale-Corpus/Apel_GC/releases/latest/download/apel_gc.zip)
  * [apel_gc.datapackage.json](https://github.com/Chorale-Corpus/Apel_GC/releases/latest/download/apel_gc.datapackage.json)
* clone the repo: `git clone https://github.com/Chorale-Corpus/Apel_GC.git`
...
notes = ms3.load_tsv("notes/A-MCAU_AP1832-001_SID026.notes.tsv")
...
See the [GitHub releases](https://github.com/Chorale-Corpus/Apel_GC/releases).

## Questions, Suggestions, Corrections, Bug Reports

Please [create an issue](https://github.com/Chorale-Corpus/Apel_GC/issues) and/or feel free to fork and submit pull requests.
